...
<div class="main_container">
    ...
    <div class="division_d">
        ...
        <div id="myDrawer" class="drawer">
            ...
            <a class="bg-white" href="<?php echo $New_cars_List_page; ?>"><span class="fas fa-car"></span><span class="fas fa-tags"></span> New Cars
        ...
        <div class="container table-container">
            ...
            <table id="car-table" class="table table-hover">
                ...
                foreach ($rows as $row) {
                    ...
                    if($row['availability'] === "Available" && $row['status'] === "Brand New"){
...
//                        The Status colors is getting from ColorGenerator.php file
                        ...
                        echo "<form action='$New_Cars_Used_controller_file' method='post' style='display: inline-block;'>
                                <input hidden type='number' id='used_id' name='used_id' value='{$row['id']}' />
                                <button class='btn btn-warning used-btn' data-id='{$row['id']}'>Used</button>
                              </form>
                              ";
                        echo "</td>";
