...
$Rented_Cars_Delete_controller_file = $backend_routes['seller_all_cars_delete_controller'];
$Cars_Edit_page = $routes['seller_edit_car'];
...
<head>
    ...
    <title>Car - Dealers -> Cars on Rent</title>
...
<div class="main_container">
    ...
    <div class="division_a" style="overflow-x: auto; width: 955px; height: 476px;">
        ...
        <div class="container table-container">
            <h2 id="table_name" style="">All Cars</h2>
...
//                        The Status colors is getting from ColorGenerator.php file
                        ...
                        echo "<td>";
                        echo "<form action='$Cars_Edit_page' method='post' style='display: inline-block;'>
                                <input hidden type='number' id='view_id' name='edit_id' value='{$row['id']}' />
                                <button type='submit' class='btn btn-warning edit-btn' data-id='{$row['id']}'>Edit</button>
                              </form>
                              ";
                        echo "&nbsp;&nbsp;"; // Inserting a space for gap
                        echo "<form action='$Rented_Cars_Delete_controller_file' method='post' style='display: inline-block;'>
                                <input hidden type='number' id='available_id' name='delete_id' value='{$row['id']}' />
                                <button class='btn btn-danger used-btn' data-id='{$row['id']}'>Delete</button>
                              </form>
                              ";
                        echo "</td>";
                        echo "</tr>";
