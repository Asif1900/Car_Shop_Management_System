...
$Rented_Cars_Available_controller_file = $backend_routes['seller_rented_cars_available_controller'];
...
<div class="main_container">
    ...
    <div class="division_d">
        ...
        <div id="myDrawer" class="drawer">
            ...
            <a class="bg-white" href="<?php echo $Rented_cars_List_page; ?>"><span class="fas fa-user"></span><span class="fas fa-car"></span> Rented Cars</a>
    ...
    <div class="division_a" style="overflow-x: auto; width: 955px; height: 476px;">
        ...
        <div class="container table-container">
            <h2 id="table_name" style="">List of Cars on Rent</h2>
...
//                        The Status colors is getting from ColorGenerator.php file
                        ...
                        echo "<form action='$Rented_Cars_Available_controller_file' method='post' style='display: inline-block;'>
                                <input hidden type='number' id='available_id' name='available_id' value='{$row['id']}' />
                                <button class='btn btn-success used-btn' data-id='{$row['id']}'>Available</button>
                              </form>
                              ";
                        echo "</td>";
                        echo "</tr>";
