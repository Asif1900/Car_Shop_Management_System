...
$Add_cars_controller_file = $backend_routes['seller_add_car_controller'];
...
<div class="main_container">
    ...
    <div class="division_d">
        ...
        <div id="myDrawer" class="drawer">
            ...
            <a class="bg-white" href="<?php echo $Add_cars_page; ?>"><span class="fas fa-plus"></span><span class="fas fa-car"></span> Add Cars</a>
            <a href="<?php echo $New_cars_List_page; ?>"><span class="fas fa-car"></span><span class="fas fa-tags"></span> New Cars
        ...
        <div class="container custom-container">
            <div class="row"">
                <div class="col-md-6 offset-md-3 border p-4 shadow bg-light mb-5" style="height: 93%">
                    <div class="col-12">
                        <h3 class="fw-normal text-secondary fs-4 text-uppercase mb-4">Car Information Form</h3>
                    </div>
                    <form action="<?php echo $Add_cars_controller_file; ?>" id="car_info_form" method="post" onsubmit="return validateForm();">
                        <div class="row g-3">
                            <div class="col-12">
                                <label for="brand" class="form-label">Brand</label>
                                <input id="brand" name="brand" class="form-control" placeholder="Enter car brand name" >
                            </div>
                            <div class="col-12">
                                <label for="model" class="form-label">Model</label>
                                <input id="model" name="model" class="form-control" placeholder="Enter car model name" required>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input id="price" name="price" class="form-control" placeholder="৳" required>
                            </div>
                            <div class="col-12 mt-4">
                                <button type="submit" class="btn btn-success float-end">Add Car</button>
