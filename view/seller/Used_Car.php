...
<head>
    ...
    <title>Car - Dealers -> Used Cars</title>
...
<div class="main_container">
    ...
    <div class="division_d">
        ...
        <div id="myDrawer" class="drawer">
            ...
            <a class="bg-white" href="<?php echo $Used_cars_List_page; ?>"><span class="fas fa-wrench"></span><span class="fas fa-car"></span> Used Cars</a>
    ...
    <div class="division_a" style="overflow-x: auto; width: 955px; height: 476px;">
        ...
        <div class="container table-container">
            <h2 id="table_name" style="">Used Car List</h2>
